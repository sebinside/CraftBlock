...
recipes.addShapeless("luaBios", luaBios, [<ore:oc:eeprom>, oc_manual.reuse()]);
recipes.addShapeless("openOs", openOs, [<ore:oc:floppy>, oc_manual.reuse()]);
